...
as1 = ArtSchedule.create(art_time: "four in the morning", art_type: "sculpture", art_id: 2, art_plan_id: 2)

#art project:
at = ArtProject.create(medium: "video", day: Date.today, idea: "Election", artist_reference: "Condit", content: "Identity", price: 3, art_plan_id: 1)
at1 = ArtProject.create(medium: "drawing", day: Date.today, idea: "Beauty", artist_reference: "Oursler", content: "Politics", price: 500, art_plan_id: 2)
